...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::resource('product-sub-categories', ProductSubCategoryAPIController::class);
    Route::post('product-sub-categories/{product_subcategory}',
        [ProductSubCategoryAPIController::class, 'update'])->name('product-sub-category');
    //    });

    Route::get('product-sub-categories', [ProductSubCategoryAPIController::class, 'index']);
    ...
    Route::post('suppliers/{supplier}',
    [SupplierAPIController::class, 'update']);
