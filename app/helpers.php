...
if (!function_exists('calculateTotalPriceCart')) {
    function calculateTotalPriceCart($cart)
    {
       $totalPrice = 0;
...
if (!function_exists('countProductInCart')) {
    function countProductInCart($product)
    {
       $total = 0;
...
if (!function_exists('countOrderItemWithPrice')) {
    function countOrderItemWithPrice($items)
    {
       $orderItem = 0;
       $totalPrice = 0;
       ...
       $showPrice = '₹'.$totalPrice.' for '.$orderItem.' item';
